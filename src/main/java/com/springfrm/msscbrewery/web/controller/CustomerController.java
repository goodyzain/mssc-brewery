package com.springfrm.msscbrewery.web.controller;

import com.springfrm.msscbrewery.services.CustomerService;
...
public class CustomerController {
    ...
    public ResponseEntity handelUpdate(@PathVariable UUID customerId,@RequestBody CustomerDto customerDto){
